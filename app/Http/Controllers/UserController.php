...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        // con pluck() extraemos ciertos valores
         // Carpeta.archivo
        // se pasa a la vista create la variable $roles
    ...
    public function show($id)
    {
        ...
        // compact() Cree un array que contenga variables y sus valores
        $user = User::find($id);
